...
Port of src/adapters/*.ts.

Usage:
    from jingu_trust_gate.adapters import ClaudeContextAdapter, OpenAIContextAdapter, GeminiContextAdapter
"""
...
from .types import VerifiedBlock, VerifiedContext
...
class GeminiContextAdapter(ContextAdapter[GeminiContent]):
    ...
    def adapt(self, context: VerifiedContext) -> GeminiContent:
        ...
        return GeminiContent(role=self._role, parts=parts)
